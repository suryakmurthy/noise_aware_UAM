...
def generate_scenario_austin(out_path, demand_dict_path, route_dict_path, dep_interval):
    ...
    if not os.path.exists(folder_path):
        os.makedirs(folder_path)
    f = open(out_path + f"/austin_env_full.scn", "w")
    ...
    for route_name in route_dict.keys():
        ...
        for aircraft_num in range(0, demand_dict[route_name]):
            ...
            time = "00:00:" + str(total_aircraft_num * dep_interval) + ".00"
...
generate_scenario_austin(f'/home/suryamurthy/UT_Autonomous_Group/vls_mod_alt/scenarios/generated_scenarios_austin', '/home/suryamurthy/UT_Autonomous_Group/vls_mod_alt/D2MAV_A/route_demand_dict.json', '/home/suryamurthy/UT_Autonomous_Group/vls_mod_alt/D2MAV_A/route_info_dict.json', 20)
